...
// Validate and sanitize the cat_id parameter
$cat_id = isset($_GET['cat_id']) ? filter_var($_GET['cat_id'], FILTER_SANITIZE_NUMBER_INT) : '';

// Check if cat_id is valid
if (empty($cat_id) || !is_numeric($cat_id)) {
  // Handle invalid cat_id 
